...
get the app created:
    ...
    $ heroku apps:create clotodo
    Creating clotodo... done, stack is cedar
    http://clotodo.herokuapp.com/ | git@heroku.com:clotodo.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://clotodo.herokuapp.com deployed to Heroku

    To git@heroku.com:clotodo.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://clotodo.herokuap.com
    ["Hello" :from Heroku]
